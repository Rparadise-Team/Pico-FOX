...
#define CPUSAVE "/mnt/SDCARD/cpu.sav"
#define GOVSAVE "/mnt/SDCARD/governor.sav"
#define SPEEDSAVE "/mnt/SDCARD/speed.sav"
...
void stopOrContinueProcesses(int value) {
    const char *exceptions[] = {"batmon", "keymon", "init", "wpa_supplicant", "udhcpc", "hostapd", "dnsmasq", "sh", "htop", "wget"};
...
void setcpu(int cpu) {
	if (cpu == 0) {
		...
		system("cp /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor /mnt/SDCARD/governor.sav");
		...
		system("cp /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor /mnt/SDCARD/governor.sav");
		system("cp /sys/devices/system/cpu/cpu0/cpufreq/scaling_setspeed /mnt/SDCARD/speed.sav");
		system("echo powersave > /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor");
		system("echo 600000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq");
		system("sync");
	}
